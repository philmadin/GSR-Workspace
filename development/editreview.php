<?php
	...
	while ($artROW = mysqli_fetch_assoc($articleQRY)) {
		...
		$Content1			= $artROW['Storyline'];
		$Content2	 		= $artROW['Gameplay'];
		$Content4			= $artROW['Audio'];
		$Content3 			= $artROW['Graphics'];
		...
		$temp				= array($artROW['storyline_rating'],$artROW['gameplay_rating'],$artROW['graphics_rating'],$artROW['audio_rating']);
				...
				<form class="grid_18 grid_0 submitform" id="submitform" method="get" action="" enctype="multipart/form-data">
					...
					<div id="techSpecifics">
						...
						<p class="scroll_section" id="manufacturerssites_section">
							...
							<input name="manufacturerssites" id="manufacturerssites" type="text" value="<?php echo $manu_site; ?>" placeholder="<?php echo $manu_site; ?>" required />
						</p>
					</div>
