<?php
	...
	while ($tROW = mysqli_fetch_array($tQUERY)) {
		...
		$Rating_1			= $tROW['storyline_rating'];
		$Rating_2			= $tROW['gameplay_rating'];
		$Rating_3			= $tROW['graphics_rating'];
		$Rating_4			= $tROW['audio_rating'];
			...
			<section id="review_page" class="grid_16">
				<p id="small_details">
					...
					if($generallabel=="Game"){
					 ...
					 ?>
					 <br>
					<small><b><a rel='nofollow' href="profile.php?profilename=<?php echo $authuser; ?>"><?php echo $author . "</a> / </b>" . date("D jS M Y", strtotime($createdate)); ?></small><br >
