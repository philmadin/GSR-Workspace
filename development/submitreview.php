...
function implode_multi($arr, $join, $key){
	...
	$SUBMIT_verdict = htmlentities($SUBMIT_verdict, ENT_QUOTES);
        $SUBMIT_trailer         = mysqli_real_escape_string($con, $_POST['trailer']);
