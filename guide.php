		...
		<article>
			...
			<section id="review_page" class="grid_16">
				...
				<p class="content" id="intro_section" style="margin:0px !important;">
					...
					<?php echo strip_tags(html_entity_decode($Page_Content[0]), $exclude_html); unset($Page_Content[0]);?>
				</p>
				<?php if($checklist!=""){?>
				...
				foreach($Page_Content as $section){
					...
					<?php echo strip_tags(html_entity_decode(str_replace("h3", "span class='sub-title'", str_replace("\r","<br>",str_replace("\n","<br>",$section)))), $exclude_html."<span>"); ?>
				</p>
				<?php } ?>
				<hr />
